...
#
#
# Autor: Cervantes Beltrán Karen Cristina 
# License: MIT
#
# ## ###############################################
...
import magic
import virtualboard
from Irrigacion import Irrigacion
from Ventilador import Ventilador,VentiladorONOFF
from Temperatura import ONOFFTEMP,Temperatura
from Radiador import PotenciaRad,ONOFFRAD
...
class WebServer(BaseHTTPRequestHandler):
	...
	def _parse_post(self, json_obj):
		...
		switcher = {
			...
			'ONOFFIrrig'  : Irrigacion,
			'Ventilador': Ventilador,
            'ONOFFVentilador': VentiladorONOFF,
            'ONOFFTEMP': ONOFFTEMP,
            'Temperatura': Temperatura,
            'Radiador':PotenciaRad,
            'ONOFFRad':ONOFFRAD
		}
